...
{formData.question ? (
            <div className="mb-4">
        <label htmlFor="question" className="block text-gray-700 text-sm font-bold mb-2">Description</label>
        <SunTextEditor
          ...
          onValueChange={(val) =>
            onValueChangeEditor('question', val)
          }
          />
...
{formData.answer ? (
            <div className="mb-4">
        <label htmlFor="answer" className="block text-gray-700 text-sm font-bold mb-2">Description</label>
        <SunTextEditor
          setOptionsType="main-admin"
          defaultValue=
          ...
          placeholder="Answer..."
          onValueChange={(val) =>
            onValueChangeEditor('answer', val)
          }
          />
        {/* <textarea id="question" name="question" value={formData.question} onChange={handleChange} rows={4} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea> */}
      </div>
      ...
      <div className="mb-4">
        <label htmlFor="important" className="block text-gray-700 text-sm font-bold mb-2">Important</label>
        <input type="number" id="important" name="important" value={formData.important} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
      </div>

      <div className="mb-4">
        <label htmlFor="level" className="block text-gray-700 text-sm font-bold mb-2">Level</label>
        <input type="number" id="level" name="level" value={formData.level} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
      </div>
      ...
      <div className="mb-4">
        <label htmlFor="subTopic" className="block text-gray-700 text-sm font-bold mb-2">Category</label>
        <select id="subTopic" name="subTopic" value={formData.subTopic} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
